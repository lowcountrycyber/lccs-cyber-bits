...
class Term:
    ...
    @property
    def link(self) -> str:
        # GitHub Pages expects links without .md extension
...
def clean_one_liner(text: str) -> str:
    ...
    # Turn Obsidian [[Wiki Links]] into plain text for the snippet
...
def render_a_z_index(terms: Iterable[Term]) -> str:
    ...
    for letter in sorted(grouped.keys()):
        ...
        for term in grouped[letter]:
            ...
            lines.append(
                f'<li class="searchable" '
                f'data-text="{data_text}" '
                f'data-category="{html.escape(term.category.lower())}">'
